<%-- 
    Document   : register
    Created on : 16 Mar 2026, 13:44:57
    Author     : ICTS
--%>
...
<div class="split-page">
  ...
  <div class="left-panel">
    ...
    <span class="l-tag">👨‍🏫 Lecturer Registration</span>
    <h2>Create Your<br>Lecturer Account</h2>
    <p>Register with your Staff ID, verify your email and start managing venue and ICT lab bookings.</p>
    <ul class="feat-list">
      <li><div class="feat-ico">🪪</div> Register with Staff ID</li>
      <li><div class="feat-ico">🔒</div> Email OTP verification</li>
      <li><div class="feat-ico">⚡</div> Instant access after signup</li>
      <li><div class="feat-ico">📅</div> Book venues for your classes</li>
    </ul>
  </div>
  ...
  <div class="right-panel">
    <div class="form-box">
      ...
      <!-- STEP 1 -->
      <div id="step1">
        <div class="form-title">Lecturer Registration</div>
        <p class="form-sub">Already registered? <a href="login.jsp">Sign in here</a></p>

        <div id="toast1" class="toast"></div>

        <!-- Role is fixed as Lecturer on this page -->
        <div class="role-display">👨‍🏫 Registering as Lecturer</div>

        <div class="field">
          <label for="uid">Staff ID</label>
          <div class="iw">
            <span class="ii">🪪</span>
            <input type="text" id="uid" placeholder="e.g. LEC2024001"/>
          </div>
          <div class="fmsg" id="uid-err">Staff ID is required.</div>
        </div>
