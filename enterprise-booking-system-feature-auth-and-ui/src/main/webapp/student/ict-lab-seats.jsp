...
/* ── Sticky navbar — matches dashboard ───────────────── */
.navbar {
    position: sticky;
    top: 0;
    z-index: 1000;
...
/* ── Main container — dashboard spacing ──────────────── */
.container {
    max-width: 1100px;
    margin: 0 auto;
    padding: 32px 24px;
...
/* ── Info card — dashboard card style ───────────────── */
.info-card {
    background: #fff;
    border-radius: 16px;
...
/* ── Placeholder / loading / error text ─────────────── */
#placeholder-text,
.loading-text,
.error-text {
    font-size: 14px;
...
<div class="container">
    ...
    <div class="info-card">
        ...
        <p><i class="fas fa-hand-pointer"></i>&nbsp; Green seats are available — click one to book it.</p>
    ...
    <div class="seat-shell">
        ...
        <div class="seat-legend">
            <div class="legend-item">
                <span class="legend-dot" style="background:#f0fdf4; border:1.5px solid #4ade80;"></span>
                Available
            </div>
            <div class="legend-item">
                <span class="legend-dot" style="background:#eff6ff; border:1.5px solid #1f6feb;"></span>
                In Use
            </div>
            <div class="legend-item">
                <span class="legend-dot" style="background:#fefce8; border:1.5px solid #9e6a03;"></span>
                Unavailable/Broken
            </div>
        </div>
...
<script>
    window.EBS_CONTEXT = '${pageContext.request.contextPath}';
        window.EBS_USER_ID  = '<%= session.getAttribute("userId") != null ? session.getAttribute("userId") : "" %>';
